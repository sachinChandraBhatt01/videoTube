...
const SavedContentPage = () => {
  ...
  //         `${serverUrl}/api/content/saveshorts`,
  //         {
  ...
  //         `${serverUrl}/api/content/savevideos`,
  //         {
  //           withCredentials: true,
  //         },
  //       );
  ...
  const fetchSavedContent = async () => {
    try {
      ...
      const [shortsRes, videosRes] = await Promise.all([
        axios.get(`${serverUrl}/api/content/saveshorts`, {
          withCredentials: true,
        }),
        axios.get(`${serverUrl}/api/content/savevideos`, {
          withCredentials: true,
        }),
      ]);

      const shorts = shortsRes.data?.savedShorts || [];
      const videos = videosRes.data?.savedVideos || [];
